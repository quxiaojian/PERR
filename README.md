...
This pipeline is used for good or normal Illumina paired-end reads data. I recommend to use my another pipeline OGA (https://github.com/quxiaojian/OGA.git).
...
```
(3) download assemble softwares such as [spades](http://bioinf.spbau.ru/spades) or [velvet](https://github.com/dzerbino/velvet), and assembly graph visual software [bandage](https://github.com/rrwick/Bandage). Also put it in your PATH.<br />
...
**Fourth**, assembling (spades or velvet) and visualizing (bandage).<br />
...
**Fifth**, assembling (spades or velvet) and visualizing (bandage).<br />
